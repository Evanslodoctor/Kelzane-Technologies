...
$.notify({
	icon: 'icon-bell',
	title: 'Welcome',
	message: 'Kelzane Technologies Admin Pannel',
},{
	type: 'secondary',
	placement: {
		from: "bottom",
...
$.ajax({
    ...
    success: function(data) {
        ...
        var statisticsChart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: data.months,  // Dynamic months
                datasets: [{
                    label: "Subscribers",
                    borderColor: '#f3545d',
                    pointBackgroundColor: 'rgba(243, 84, 93, 0.6)',
                    ...
                    fill: true,
                    borderWidth: 2,
                    data: data.subscribers  // Dynamic data
                }, {
                    label: "New Visitors",
                    borderColor: '#fdaf4b',
                    pointBackgroundColor: 'rgba(253, 175, 75, 0.6)',
                    ...
                    fill: true,
                    borderWidth: 2,
                    data: data.new_visitors  // Dynamic data
                }, {
                    label: "Active Users",
                    borderColor: '#177dff',
                    pointBackgroundColor: 'rgba(23, 125, 255, 0.6)',
                    ...
                    fill: true,
                    borderWidth: 2,
                    data: data.active_users  // Dynamic data
                }]
            },
            options: {
                responsive: true, 
